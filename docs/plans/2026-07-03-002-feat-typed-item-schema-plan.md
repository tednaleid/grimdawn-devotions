...
- **Execution note:** Build the requirements evaluator against the oracles first — Sacrificial Knife 74/93 and The Guillotine physique 426 are the failing tests to make pass before wiring the rest; ask Ted for one shield and one jewelry grimtools card early to pin the KTD3 derivations.
